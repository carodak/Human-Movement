...
# An AdaBoost classifier for the dataset MPII
def main():
    # Load the data
    ...
    # We need the x_data under the form [[32joints of image1], [32joints of image2], []...]
    data = np.reshape(MPII_dataset, (n, 32))

    # We just take a subset of the data to train -> 100 first images
    x_train = np.delete(data, slice(101, n), 0)
    y_train = np.delete(MPII_dataset_label, slice(101,n),0)
